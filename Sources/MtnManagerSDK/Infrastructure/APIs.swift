...
open class MtnManagerSDKAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://your-resort.mtnmanager.com",
    ...
    public static let shared = MtnManagerSDKAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: MtnManagerSDKAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: MtnManagerSDKAPIConfiguration = MtnManagerSDKAPIConfiguration.shared) {
        self.method = method
