...
open class MtnManagerAPI {
    ...
    /**
     ...
     - returns: AppReport
     */
    open class func getAppReport(acceptLanguage: String? = nil, apiConfiguration: MtnManagerSDKAPIConfiguration = MtnManagerSDKAPIConfiguration.shared) async throws(ErrorResponse) -> AppReport {
        return try await getAppReportWithRequestBuilder(acceptLanguage: acceptLanguage, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter acceptLanguage: (header) Preferred language and optional region for human-readable strings in the response (e.g. operating hours summaries). Supports &#x60;en&#x60;, &#x60;fr&#x60;, &#x60;de&#x60;, &#x60;it&#x60;, and &#x60;es&#x60;, with optional region tags such as &#x60;fr-CA&#x60; or &#x60;de-CH&#x60;. Defaults to English when omitted or unsupported. (optional)
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<AppReport> 
     */
    open class func getAppReportWithRequestBuilder(acceptLanguage: String? = nil, apiConfiguration: MtnManagerSDKAPIConfiguration = MtnManagerSDKAPIConfiguration.shared) -> RequestBuilder<AppReport> {
        let localVariablePath = "/api/v1/report/app"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<AppReport>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
